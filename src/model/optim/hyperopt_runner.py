...
SEARCH_SPACES = {
    ...
    "cnn": {
        ...
        "epochs": scope.int(hp.quniform("cnn_epochs", 10, 30, q=5)),
    },
    "resnet": {
        ...
        "epochs": scope.int(hp.quniform("resnet_epochs", 10, 30, q=5)),
    },
    "convnext": {
        ...
        "epochs": scope.int(hp.quniform("convnext_epochs", 10, 30, q=5)),
    },
}
